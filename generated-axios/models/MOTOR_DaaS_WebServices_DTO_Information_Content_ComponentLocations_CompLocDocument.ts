...
export type MOTOR_DaaS_WebServices_DTO_Information_Content_ComponentLocations_CompLocDocument = {
    /**
     * Whether the containing application (component) resides in the image or not.
     */
